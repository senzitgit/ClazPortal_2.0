...
function parseResult(result) {
    ...
    if (origin == "shareAttachment") {
       ...
       addAttach.innerHTML = '<article id="chat-id-1" class="chat-item right"> <a href="javascript:void(0)" class="pull-right thumb-sm avatar"><img src="' + ProfilePicURL + '" class="img-circle"></a> <section class="chat-body" > <div class="panel bg bg-success text-sm m-b-none"  style="background-color:#5BBFAB"> <div class="panel-body" style="height:30px;padding: 5px;"> <span class="arrow right" style="border-left-color:#5BBFAB"></span>' + cur.name + '<a href="javascript:void(0)" onclick="openPopup(' + attachmentListFlag + ')"><div class="fa fa-eye" Style="font-size:15px;float:right;color:#fff"></div> </a>    <a href="' + cur.link + '" download><div class="fa fa-download" Style="font-size:15px;float:right;margin-right:20px;color:#fff"></div></a></div>  </div> <small class="text-muted"><i class="fa fa-paperclip"></i>&nbsp;&nbsp;Type : ' + cur.type + '</small> </section> </article>' + addAttach.innerHTML;
        ...
        addLogs.innerHTML = '<article style="margin-right:10px;" id="chat-id-1" class="chat-item left"> <a href="javascript:void(0)" class="pull-left thumb-sm avatar"><img src="' + ProfilePicURL + '" class="img-circle"></a> <section class="chat-body"> <div class="panel text-sm m-b-none"> <div class="panel-body" style=" height: 35px;padding: 5px;background-color:#5BBFAB;color:#fff; "> <span class="arrow left" style="border-right-color:#5BBFAB;"></span><span style="font-size:12px; margin-top:-30px;">' + cur.name + ' File shared</span> </div> </div> <small class="text-muted"><i class="fa fa-check text-success"></i>' + cur.timestamp + '</small> </section> </article>' + addLogs.innerHTML;
       ...
       // document.getElementById('logButton').style['-webkit-animation'] = 'pulse-border 1s infinite';
        ...
        if (cur.raiseHandText == "0") {
            var addLogs = document.getElementById('addLogs');
            addLogs.innerHTML = '<article style="margin-right:10px;" id="chat-id-1" class="chat-item left"> <a href="javascript:void(0)" class="pull-left thumb-sm avatar"><img src="' + cur.profilePic + '" class="img-circle"></a> <section class="chat-body"> <div class="panel text-sm m-b-none"> <div class="panel-body" style=" height: 35px; padding: 5px;background-color:#5BBFAB;color:#fff; "> <span class="arrow left" style="border-right-color:#5BBFAB;"></span><span style="font-size:12px; margin-top:-30px;">' + cur.logText + '</span> </div> </div> <small class="text-muted"><i class="fa fa-check text-success"></i>' + cur.timestamp + '</small> </section> </article>' + addLogs.innerHTML;
        } else {
            ...
            var addLogs = document.getElementById('addLogs');
            addLogs.innerHTML = '<article style="margin-right:10px;" id="chat-id-1" class="chat-item left"> <a href="javascript:void(0)" class="pull-left thumb-sm avatar"><img src="' + cur.profilePic + '" class="img-circle"></a> <section class="chat-body"> <div class="panel text-sm m-b-none"> <div class="panel-body" style=" height: 35px; padding: 5px;background-color:#5BBFAB;color:#fff; "> <span class="arrow left" style="border-right-color:#5BBFAB;"></span><span style="font-size:12px; margin-top:-30px;">' + cur.logText + '</span> <a href="javascript:void(0)" onclick="RHModal(' + raiseHandListFlag + ')" style="float:right;"><div style="color:#fff;font-size:15px;" class="fa fa-comment"></div></a></div> </div> <small class="text-muted"><i class="fa fa-check text-success"></i>' + cur.timestamp + '</small> </section> </article>' + addLogs.innerHTML;
                ...
                if (arrayLength > 0) {
                    for (var i = 0; i < arrayLength; i++) {
                        ...
                        if (cur.raiseHandText == "0") {
                            ...
                            var addLogs = document.getElementById('addLogs');
                            addLogs.innerHTML = '<article style="margin-right:10px;" id="chat-id-1" class="chat-item left"> <a href="javascript:void(0)" class="pull-left thumb-sm avatar"><img src="' + propic + '" class="img-circle"></a> <section class="chat-body"> <div class="panel text-sm m-b-none"> <div class="panel-body" style="height: 35px; padding: 5px;background-color:#5BBFAB;color:#fff; "> <span class="arrow left" style="border-right-color:#5BBFAB;"></span><span style="font-size:12px; margin-top:-30px;">' + logtex + '</span> <a href="javascript:void(0)" onclick="RHModal(' + raiseHandListFlag + ')" style="float:right;"><div style="color:#fff;font-size:15px;" class="fa fa-comment"></div></a></div> </div> <small class="text-muted"><i class="fa fa-check text-success"></i>' + ts + '</small> </section> </article>' + addLogs.innerHTML;

                            raiseHandListFlag++;

                            var raiseHandDoubts = document.getElementById(raiseHandText);
                            raiseHandDoubts.innerHTML = '<article id="' + raiseHandText + '" style="" id="chat-id-1" class="chat-item left"> <a href="javascript:void(0)" class="pull-left thumb-sm avatar"><img src="' + Teachimage + '" class="img-circle"></a> <section class="chat-body"> <div class="panel text-sm m-b-none">    <div class="panel-body" style=" height: 35px;padding: 5px;background-color:#5BBFAB;color:#fff; "> <span class="arrow left" style="border-right-color:#5BBFAB"></span>' + raiseHandText + ' <br>Answer : ' + raiseHandAnswer + ' </div></div> <small class="text-muted"><i class="fa fa-circle text-success text-xs"></i> </small> &nbsp;Answered </section> </article>';
